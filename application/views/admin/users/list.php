    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-12 text-left">
                ...
                <a class="btn btn-primary" href="<?php echo base_url('admin/users/add'); ?>" title="<?php echo lang('users tooltip add_new_user') ?>" data-toggle="tooltip"><?php echo lang('users button add_new_user'); ?></a>
            </div>
        </div>
    </div>
                ...
                <?php echo form_open("{$this_url}?sort={$sort}&dir={$dir}&limit={$limit}&offset=0{$filter}", array('role'=>'form', 'id'=>"filters")); ?>
                    ...
                    <th colspan="3">
                        <div class="text-right">
                            <a href="<?php echo $this_url; ?>" class="btn btn-danger" data-toggle="tooltip" title="<?php echo lang('admin tooltip filter_reset'); ?>"> <?php echo lang('core button reset'); ?></a>
                            <button type="submit" name="submit" value="<?php echo lang('core button filter'); ?>" class="btn btn-primary" data-toggle="tooltip" title="<?php echo lang('admin tooltip filter'); ?>"><?php echo lang('core button filter'); ?></button>
                        </div>
                    </th>
                <?php echo form_close(); ?>
            </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="text-right">
                                <div class="btn-group">
                                    <?php if ($user['id'] > 1) : ?>
                                        <a href="#modal-<?php echo $user['id']; ?>" data-toggle="modal" class="btn btn-danger btn-action" data-toggle="tooltip" title="<?php echo lang('admin button delete'); ?>"><i class="fas fa-trash"></i></a>
                                    <?php endif; ?>
                                    <a href="<?php echo $this_url; ?>/edit/<?php echo $user['id']; ?>" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="<?php echo lang('admin button edit'); ?>"><i class="fas fa-pencil-alt"></i></a>
                                </div>
                            </div>
                        </td>
                    </tr>
    ...
    <div class="panel-footer">
        <div class="row">
            ...
            <div class="col-md-2 text-right">
                <?php if ($total) : ?>
                    <a href="<?php echo $this_url; ?>/export?sort=<?php echo $sort; ?>&dir=<?php echo $dir; ?><?php echo $filter; ?>" class="btn btn-primary" data-toggle="tooltip" title="<?php echo lang('admin tooltip csv_export'); ?>"><span class="glyphicon glyphicon-export"></span> <?php echo lang('admin button csv_export'); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
