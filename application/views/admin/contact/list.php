                        ...
                        <td>
                            <div class="text-right">
                                <div class="btn-group">
                                    ...
                                    <?php else : ?>
                                        <a href="#modal-<?php echo $message['id']; ?>" data-toggle="modal" data-read="false" class="btn btn-primary btn-xs" title="<?php echo lang('contact button read'); ?>"><i class="fas fa-envelope"></i></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
    ...
    <div class="panel-footer">
        <div class="row">
            ...
            <div class="col-md-2 text-right">
                <?php if ($total) : ?>
                    <a href="<?php echo $this_url; ?>/export?sort=<?php echo $sort; ?>&dir=<?php echo $dir; ?><?php echo $filter; ?>" class="btn btn-primary"><span class="glyphicon glyphicon-export"></span> <?php echo lang('admin button csv_export'); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
